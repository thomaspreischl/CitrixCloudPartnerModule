function New-PartnerCustomer {
    ...
    param(
      ...
      if (!$identityProvider) { 
          ...
          Write-Verbose "Identity Provider for customer was set to 'Cas'(default)" -Verbose
      }
      else {
      ...
      Write-Verbose 'Customer was successfully created!'`r`n -Verbose
  
      }
      
      catch {
          Write-Verbose 'Not able to create the new account:'`r`n -Verbose
