...
Function Connect-CitrixAPI{
	<#
		...
		You can also use this command to authenticate on Citrix Cloud and use other Powershell or Rest Calls. With the help of the command it is not necessary to download or install the SDK.
	    .PARAMETER partnerID
